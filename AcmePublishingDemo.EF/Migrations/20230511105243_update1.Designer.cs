...
namespace AcmePublishingDemo.EF.Migrations
{
    ...
    [Migration("20230511105243_update1")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DistributionCompanyEntityPublicationEntity", b =>
                {
                    b.Property<long>("DistributionCompaniesId")
                        .HasColumnType("bigint");

                    b.Property<long>("PublicationsId")
                        .HasColumnType("bigint");

                    b.HasKey("DistributionCompaniesId", "PublicationsId");

                    b.HasIndex("PublicationsId");

                    b.ToTable("DistributionCompanyEntityPublicationEntity");
                });
            ...
            modelBuilder.Entity("DistributionCompanyEntityPublicationEntity", b =>
                {
                    b.HasOne("AcmePublishingDemo.EF.Entities.DistributionCompanyEntity", null)
                        .WithMany()
                        .HasForeignKey("DistributionCompaniesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AcmePublishingDemo.EF.Entities.PublicationEntity", null)
                        .WithMany()
